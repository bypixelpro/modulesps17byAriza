<div class="panel mymodule-admin-panel">
    <div class="panel-heading">
        <i class="icon-cogs"></i> {l s='Custom Admin' mod='mymodule'}
    </div>
    ...
    <div class="form-wrapper">       
        <form action="{$mymodule.postAction}" method="post" enctype="application/x-www-form-urlencoded,multipart/form-data">
                            ...
                            <div class="translatable-field lang-{$lang["id_lang"]}" {if $mymodule.currentLang != $lang["id_lang"]}style="display: none;"{/if}>
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="{$mymodule.customControls['MYMODULE_SAVE_NAME']['controlName']}_{$lang["id_lang"]}" name="{$mymodule.customControls['MYMODULE_SAVE_NAME']['controlName']}_{$lang["id_lang"]}" class="mymodule-language" value="{$mymodule.customControls['MYMODULE_SAVE_NAME']['values'][$lang["id_lang"]]}" onkeyup="if (isArrowKey(event)) return ;updateFriendlyURL();"/>
                                    </div>                                  
                                </div>
                                <div class="col-lg-2">
            ...
            <div class="panel-footer">
                <button type="submit" value="1" id="{$mymodule.saveButton['MYMODULE_SAVE_FORM']['controlName']}" name="{$mymodule.saveButton['MYMODULE_SAVE_FORM']['controlName']}" class="btn btn-default pull-right">
